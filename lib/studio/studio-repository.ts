import type { ChecklistTemplate, ChecklistTemplateCategory, ChecklistTemplateItem, ClientProfile, DocumentRecord, ID, Organization, Practice, PracticeItem, PracticeItemStatus, PracticeStatus } from "@/types/models";
...
export interface StudioRepository {
  ...
  updatePracticeItem(organizationId: ID, practiceItemId: ID, input: { status: PracticeItemStatus; required: boolean; note?: string | null }): Promise<PracticeItem>;
